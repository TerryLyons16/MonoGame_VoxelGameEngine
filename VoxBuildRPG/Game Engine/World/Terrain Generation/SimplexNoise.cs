...
namespace VoxBuildRPG.GameEngine.World.TerrainGeneration
{
 ...
 */
        public double XScale = 100;//0.02;
        public double YScale = 100;//0.02;
        ...
        public SimplexNoise(double pScale, byte pOctaves)
        {
            XScale = pScale;
            YScale = pScale;
            Octaves = pOctaves;
        ...
        public SimplexNoise(double pXScale, double pYScale, byte pOctaves)
        {
            XScale = pXScale;
            YScale = pYScale;
            Octaves = pOctaves;
