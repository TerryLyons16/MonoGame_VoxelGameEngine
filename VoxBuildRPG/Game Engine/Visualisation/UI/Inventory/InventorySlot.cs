...
namespace VoxelRPGGame.GameEngine.UI.Inventory
{
    ...
    {
        private InventoryItemView _inventoryItem = null;

        private Vector2 _positionRelative;//position relative to whatever inventory it is in
        ...
        public InventorySlot(Vector2 TEMPposition, InventoryView owner)
        {
            _owner = owner;
            _slotTexture = ScreenManager.GetInstance().ContentManager.Load<Texture2D>("Textures\\UI\\InventorySlot");
            _positionAbsolute = new Vector2(TEMPposition.X, TEMPposition.Y);
       ...
       //     _inventoryItem = new InventoryItemView(null, _positionAbsolute,this);
        ...
        public InventorySlot(Vector2 TEMPposition, InventoryItem item, InventoryView owner)
            : this(TEMPposition,owner)
        {
